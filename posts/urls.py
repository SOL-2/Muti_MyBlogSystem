...
urlpatterns = [
    ...
    path('<int:post_id>/detail/sendcomment/', views.p_detail, name='send_comment'),
    path('<int:post_id>/detail/<int:comment_post>/delcomment', views.c_delete, name='del_comment_detail'),
